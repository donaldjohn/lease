...
// |  PROJECT_NAME: lease
// +--------------------------------------------------------
// |  FILE_NAME: InsurerController.php
// +--------------------------------------------------------
// |  AUTHOR: zhengchao
// +--------------------------------------------------------
...
class InsurerController extends BaseController
{
    ...
    {
        $company = $this->userData->getCompanyPage($this->authed,SystemType::INSURER);
    ...
    public function CreateAction()
    {
        ...
        $json['scope'] = '无';
        $company = $this->userData->createCompany($this->authed,$json,SystemType::INSURER);
        return $this->toSuccess($company);
    }
    ...
    public function List2Action(){
        ...
        $parameter = [
            ...
            "userType" => (int)SystemType::INSURER,
        ];

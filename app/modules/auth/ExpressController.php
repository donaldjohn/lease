...
class ExpressController extends BaseController
{
    ...
    {
        $company = $this->userData->getCompanyPage($this->authed,SystemType::EXPRESS);
    ...
    public function OneAction($id)
    {
        ...
        if ($user['insId'] == -1)
            return $this->toError(500,'用户暂无快递公司信息');
    ...
    public function CreateAction()
    {
        ...
        $json['scope'] = "快递公司";
        $company = $this->userData->createCompany($this->authed,$json,SystemType::EXPRESS);
        return $this->toSuccess($company);
    }
    ...
    public function List2Action(){
        ...
        $parameter = [
            ...
            "userType" => (int)SystemType::EXPRESS,
        ];
